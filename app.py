...
# 🔥 여기 추가!
with st.expander("💡 주제 입력 가이드 (클릭해서 보기)"):
    st.markdown("""
    **✅ 입력 방식:**
    - 단어형: `미세플라스틱`, `회절현상`, `태양전지`
    - 주제형: `빛을 활용한 프랑크상수 구하기`, `식물에서 추출한 천연 염료`
    
    **⚠️ 주의사항:**
    - 연관성 있는 과학 개념들을 조합해주세요
    - 동떨어진 주제(예: 꿀벌+광전효과)는 부정확한 결과를 낼 수 있어요
    
    **📚 추천 주제 예시:**
    `나노소재 의료응용`, `인공지능 신약개발`, `재생에너지 저장기술`
    """)
